!(function (a, i) {
  ...
  function d(a, i) {
    for (var e, r; (r = 6e4 * (((i.at - a.at) / 12e4) | 0)); )
      (e = new M(new Date(a.at + r))).offset === a.offset ? (a = e) : (i = e);
    return a;
  }
  function h(a, i) {
    ...
    var e,
      ...
      c = (function () {
        var a,
          ...
          c = [o];
        for (e = 1; e < 48; e++)
          (i = new M(new Date(r, e, 1))).offset !== o.offset &&
            ((a = d(o, i)), c.push(a), c.push(new M(new Date(a.at + 6e4)))),
            (o = i);
        for (e = 0; e < 4; e++)
          c.push(new M(new Date(r + e, 0, 1))),
            c.push(new M(new Date(r + e, 6, 1)));
        return c;
      })(),
      A = c.length,
      n = (function (a) {
  ...
  function B(a) {
    ...
    return (
      r && !c.isMoment(a) && k(o) && o.add(r.parse(o), "minutes"), o.tz(e), o
    );
  }
  (e < 2 || (2 == e && r < 6)) &&
    L(
    ...
    (p.prototype = {
      ...
      parse: function (a) {
        ...
        for (o = 0; o < t; o++)
          if (
            ...
            (e = A[o + 1]),
            (r = A[o ? o - 1 : o]),
            i < e && B.moveAmbiguousForward
              ? (i = e)
              : r < i && B.moveInvalidForward && (i = r),
            c < n[o] - 6e4 * i)
          )
            return A[o];
        return A[t];
      ...
      offset: function (a) {
        return (
          L("zone.offset has been deprecated in favor of zone.utcOffset"),
    ...
    (B.names = function () {
      var a,
        i = [];
      for (a in s)
        s.hasOwnProperty(a) && (A[a] || A[n[a]]) && s[a] && i.push(s[a]);
      return i.sort();
    }),
    (B.Zone = p),
    (B.unpack = l),
    (B.unpackBase60 = o),
    (B.needsOffset = k),
    (B.moveInvalidForward = !0),
    (B.moveAmbiguousForward = !1);
  var C,
    O = c.fn;
  function N(a) {
    return function () {
  ...
  (c.tz = B),
      ...
      if (
        (void 0 === a._z &&
          (r &&
            k(a) &&
            !a._isUTC &&
            ((a._d = c.utc(a._a)._d), a.utc().add(r.parse(a), "minutes")),
          (a._z = r)),
        a._z)
      )
        if (
    ...
    (O.zoneName = N(O.zoneName)),
    (O.zoneAbbr = N(O.zoneAbbr)),
    (O.utc = D(O.utc)),
    (O.local = D(O.local)),
    (O.utcOffset =
      ((C = O.utcOffset),
      function () {
        return (
          0 < arguments.length && (this._z = null), C.apply(this, arguments)
        );
      })),
