var tzCountries = {
  ...
  AX: { name: "Åland Islands", abbr: "AX", zones: ["Europe/Helsinki"] },
  ...
  BQ: { name: "Caribbean NL", abbr: "BQ", zones: ["America/Curacao"] },
  BR: {
    name: "Brazil",
    abbr: "BR",
    zones: [
  ...
  CI: { name: "Côte d'Ivoire", abbr: "CI", zones: ["Africa/Abidjan"] },
  ...
  DE: { name: "Germany", abbr: "DE", zones: ["FR"] },
  ...
  ML: { name: "Mali", abbr: "ML", zones: ["Africa/Bamako"] },
  ...
  RE: { name: "Réunion", abbr: "RE", zones: ["Indian/Reunion"] },
  ...
  SX: { name: "St Maarten (Dutch)", abbr: "SX", zones: ["America/Curacao"] },
