...
var App = (function () {
  ...
  var j = $("body");
  var d = $(".am-wrapper");
  var g = $(".am-left-sidebar");
  var l = $(".am-right-sidebar");
  var k = false;
  function o(s) {
    var r = $("<div></div>").addClass(s).appendTo("body");
    var q = r.css("background-color");
    r.remove();
    return q;
  }
  function a() {
    function u() {
      j.addClass(f.openLeftSidebarClass + " " + f.transitionClass);
      k = true;
    }
    function q() {
      j.removeClass(f.openLeftSidebarClass).addClass(f.transitionClass);
      i();
    }
    function r(v) {
      var w = $(".sidebar-elements > li", g);
      ...
      $.each(w, function (z, x) {
        ...
        var y = $(this).find("> ul");
        var B = $("> li", y);
        var C = $('<li class="title">' + C + "</li>");
        var A = $(
          '<li class="nav-items"><div class="am-scroller nano"><div class="content nano-content"><ul></ul></div></div></li>'
        );
        if (!y.find("> li.title").length > 0) {
          y.prepend(C);
    ...
    $(".am-toggle-left-sidebar").on("click", function (v) {
      if (k && j.hasClass(f.openLeftSidebarClass)) {
        q();
      } else {
        if (!k) {
          u();
    ...
    $(document).on("touchstart mousedown", function (v) {
      if (
        !$(v.target).closest(g).length &&
        j.hasClass(f.openLeftSidebarClass)
      ) {
        q();
      }
    });
    var t = $(".sidebar-elements > li > a", g);
    t.on("mouseover", function () {
      var x = $(this).parent().find(".am-scroller");
      var v = $(this).parent();
      var w = v.find("> ul");
      if (!$.isXs()) {
        w.addClass("visible");
    ...
    $(".sidebar-elements li a", g).on("click", function (y) {
      if ($.isXs()) {
        var x = $(this),
          z,
          w = f.leftSidebarSlideSpeed;
        z = x.parent().siblings(".open");
        if (z) {
          z.toggleClass("open").find("> ul:visible").slideUp({ duration: w });
        }
        ...
        var v = $(".sidebar-elements > li > ul:visible", g);
        v.addClass("hide");
        setTimeout(function () {
          v.removeClass("hide");
        }, 50);
    ...
    r();
    if (d.hasClass("am-fixed-sidebar")) {
      var s = $(".am-left-sidebar > .content");
  ...
  function c() {
    function r() {
      j.addClass(f.openRightSidebarClass + " " + f.transitionClass);
    }
    function q() {
      j.removeClass(f.openRightSidebarClass).addClass(f.transitionClass);
      i();
    }
    if (l.length > 0) {
      $(".am-toggle-right-sidebar").on("click", function (s) {
        if (k && j.hasClass(f.openRightSidebarClass)) {
          q();
        } else {
          if (!k) {
            r();
      ...
      $(document).on("mousedown touchstart", function (s) {
        if (
          !$(s.target).closest(l).length &&
          j.hasClass(f.openRightSidebarClass)
        ) {
          q();
        }
      });
  ...
  function h() {
    d.swipe({
      ...
      swipeRight: function (q) {
        if (!k && !d.hasClass(f.removeLeftSidebarClass)) {
          j.addClass(f.openLeftSidebarClass + " " + f.transitionClass);
          k = true;
        }
      },
      swipeLeft: function (q) {
        if (!k && l.length > 0) {
          j.addClass(f.openRightSidebarClass + " " + f.transitionClass);
          k = true;
        }
      },
      threshold: f.swipeTreshold,
    });
  }
  function n() {
    var B = $(".am-right-sidebar .tab-pane.chat");
    var r = $(".chat-contacts", B);
    var x = $(".chat-window", B);
    var s = $(".chat-messages", x);
    var t = $(".content > ul", s);
    var q = $(".nano-content", s);
    var u = $(".chat-input", x);
    var z = $("input", u);
    var w = $(".send-msg", u);
    function A() {
      if (!B.hasClass("chat-opened")) {
        B.addClass("chat-opened");
        $(".am-scroller", s).nanoScroller();
      }
    }
    function v() {
      if (B.hasClass("chat-opened")) {
        B.removeClass("chat-opened");
      }
    }
    $(".user a", r).on("click", function (C) {
      $(".am-scroller", r).nanoScroller({ stop: true });
      A();
      C.preventDefault();
    });
    $(".title .return", x).on("click", function (C) {
      v();
      e();
    });
    function y(E, C) {
      var D = $('<li class="' + (C ? "self" : "friend") + '"></li>');
      if (E != "") {
        $('<div class="msg">' + E + "</div>").appendTo(D);
        D.appendTo(t);
        q.stop().animate({ scrollTop: q.prop("scrollHeight") }, 900, "swing");
        e();
      }
    }
    z.keypress(function (D) {
  ...
  function p() {
    var s = 220;
    var r = 500;
    var q = $('<div class="am-scroll-top"></div>');
    q.appendTo("body");
    ...
    q.on("touchstart mouseup", function (t) {
      $("html, body").animate({ scrollTop: 0 }, r);
      t.preventDefault();
    });
  }
  var m = (function () {
  ...
  return {
    ...
    init: function (r) {
      ...
      if (typeof atob === "function") {
        var s = atob("bWV0YVtuYW1lPWNvcHlyaWdodF0=");
        var q = atob("Y29udGVudA==");
        s = $(s).attr(q);
        if (
          typeof s === "undefined" ||
          s !== atob("Q29weXJpZ2h0IChjKSBDb21mb3J0IFNvZnR3YXJlIEdyb3Vw")
        ) {
          setTimeout(function () {
            $(".row").hide();
          }, 300);
    ...
    closeSubMenu: function () {
      var q = $(".sidebar-elements > li > ul:visible", g);
      q.addClass("hide");
      setTimeout(function () {
        q.removeClass("hide");
      }, 50);
...
!(function () {
    ...
    if (
      ...
      n &&
        ...
        Event.prototype.stopImmediatePropagation ||
          ((a.removeEventListener = function (b, u, g) {
            var f = Node.prototype.removeEventListener;
            "click" === b
              ? f.call(a, b, u.hijacked || u, g)
              : f.call(a, b, u, g);
          }),
          (a.addEventListener = function (b, u, g) {
            ...
            "click" === b
              ? f.call(
                  ...
                  b,
                  u.hijacked ||
                    (u.hijacked = function (d) {
                      d.propagationStopped || u(d);
                    }),
                  g
                )
              : f.call(a, b, u, g);
  ...
  var h = navigator.userAgent.indexOf("Windows Phone") >= 0,
  ...
  (i.prototype.needsClick = function (b) {
    ...
    (i.prototype.needsFocus = function (b) {
      switch (b.nodeName.toLowerCase()) {
        case "textarea":
          return !0;
        case "select":
    ...
    (i.prototype.determineEventType = function (b) {
      return n && "select" === b.tagName.toLowerCase() ? "mousedown" : "click";
    }),
    (i.prototype.focus = function (d) {
      var c;
      m &&
      d.setSelectionRange &&
      0 !== d.type.indexOf("date") &&
      "time" !== d.type &&
      "month" !== d.type
        ? ((c = d.value.length), d.setSelectionRange(c, c))
        : d.focus();
    }),
    ...
    (i.prototype.getTargetElementFromEventTarget = function (b) {
    ...
    (i.prototype.onTouchStart = function (e) {
      ...
      if (
        ((d = this.getTargetElementFromEventTarget(e.target)),
        (o = e.targetTouches[0]),
        m)
      ) {
        ...
        if (!l) {
          ...
          (this.lastTouchIdentifier = o.identifier), this.updateScrollParent(d);
        }
      }
      return (
    ...
    (i.prototype.touchHasMoved = function (e) {
      ...
      return Math.abs(d.pageX - this.touchStartX) > f ||
        Math.abs(d.pageY - this.touchStartY) > f
        ? !0
        : !1;
    }),
    (i.prototype.onTouchMove = function (b) {
      return this.trackingClick
        ? ((this.targetElement !==
            this.getTargetElementFromEventTarget(b.target) ||
            this.touchHasMoved(b)) &&
            ((this.trackingClick = !1), (this.targetElement = null)),
          !0)
        : !0;
    }),
    (i.prototype.findControl = function (b) {
      return void 0 !== b.control
        ? b.control
        : b.htmlFor
        ? document.getElementById(b.htmlFor)
        : b.querySelector(
            "button, input:not([type=hidden]), keygen, meter, output, progress, select, textarea"
          );
    }),
    (i.prototype.onTouchEnd = function (d) {
      var c,
        q,
        p,
        o,
      ...
      if (
        ...
        (q = this.trackingClickStart),
        (this.trackingClick = !1),
        (this.trackingClickStart = 0),
        k &&
          ((f = d.changedTouches[0]),
          (e =
            document.elementFromPoint(
              f.pageX - window.pageXOffset,
              f.pageY - window.pageYOffset
            ) || e),
          (e.fastClickScrollParent = this.targetElement.fastClickScrollParent)),
        ...
        if (this.needsFocus(e)) {
          return d.timeStamp - q > 100 ||
            (m && window.top !== window && "input" === p)
            ? ((this.targetElement = null), !1)
            : (this.focus(e),
              this.sendClick(e, d),
              (m && "select" === p) ||
                ((this.targetElement = null), d.preventDefault()),
              !1);
        }
      }
      return m &&
        ...
        ? !0
        : (this.needsClick(e) || (d.preventDefault(), this.sendClick(e, d)),
          !1);
    }),
    (i.prototype.onTouchCancel = function () {
      (this.trackingClick = !1), (this.targetElement = null);
    }),
    (i.prototype.onMouse = function (b) {
      return this.targetElement
        ? b.forwardedTouchEvent
          ? !0
          : b.cancelable &&
    ...
    (i.prototype.onClick = function (d) {
      var c;
      return this.trackingClick
        ? ((this.targetElement = null), (this.trackingClick = !1), !0)
        : "submit" === d.target.type && 0 === d.detail
        ? !0
        : ((c = this.onMouse(d)), c || (this.targetElement = null), c);
    }),
    (i.prototype.destroy = function () {
      var b = this.layer;
      n &&
        (b.removeEventListener("mouseover", this.onMouse, !0),
        b.removeEventListener("mousedown", this.onMouse, !0),
        b.removeEventListener("mouseup", this.onMouse, !0)),
        b.removeEventListener("click", this.onClick, !0),
        b.removeEventListener("touchstart", this.onTouchStart, !1),
        b.removeEventListener("touchmove", this.onTouchMove, !1),
        b.removeEventListener("touchend", this.onTouchEnd, !1),
        b.removeEventListener("touchcancel", this.onTouchCancel, !1);
    }),
    (i.notNeeded = function (g) {
      var c, q, p, o;
      if ("undefined" == typeof window.ontouchstart) {
        return !0;
      }
      if ((q = +(/Chrome\/([0-9]+)/.exec(navigator.userAgent) || [, 0])[1])) {
        if (!n) {
          return !0;
        }
      ...
      if (
        j &&
        ((p = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/)),
        p[1] >= 10 &&
          p[2] >= 3 &&
      ...
      return "none" === g.style.msTouchAction ||
        "manipulation" === g.style.touchAction
        ? !0
        : ((o = +(/Firefox\/([0-9]+)/.exec(navigator.userAgent) || [, 0])[1]),
          o >= 27 &&
          ((c = document.querySelector("meta[name=viewport]")),
          c &&
            (-1 !== c.content.indexOf("user-scalable=no") ||
              document.documentElement.scrollWidth <= window.outerWidth))
            ? !0
            : "none" === g.style.touchAction ||
              "manipulation" === g.style.touchAction
            ? !0
            : !1);
    }),
    (i.attach = function (a, d) {
      return new i(a, d);
    }),
    "function" == typeof define && "object" == typeof define.amd && define.amd
      ...
      ? ((module.exports = i.attach), (module.exports.FastClick = i))
      : (window.FastClick = i);
})();
/*!
 * TinyColor v1.2.1
...
!(function () {
  function M(U, W) {
    ...
    var V = K(U);
    (this._originalInput = U),
      (this._r = V.r),
      (this._g = V.g),
      (this._b = V.b),
      (this._a = V.a),
      (this._roundA = A(100 * this._a) / 100),
      (this._format = W.format || V.format),
      (this._gradientType = W.gradientType),
  ...
  function K(V) {
    var W = { r: 0, g: 0, b: 0 },
      ...
      Y = !1;
    return (
      "string" == typeof V && (V = u(V)),
      "object" == typeof V &&
        (V.hasOwnProperty("r") && V.hasOwnProperty("g") && V.hasOwnProperty("b")
          ? ((W = g(V.r, V.g, V.b)),
            (X = !0),
            (Y = "%" === String(V.r).substr(-1) ? "prgb" : "rgb"))
          : V.hasOwnProperty("h") &&
            V.hasOwnProperty("s") &&
            V.hasOwnProperty("v")
          ? ((V.s = o(V.s)),
  ...
  function g(W, V, U) {
    return { r: 255 * O(W, 255), g: 255 * O(V, 255), b: 255 * O(U, 255) };
  }
  function n(U, Y, aa) {
    (U = O(U, 255)), (Y = O(Y, 255)), (aa = O(aa, 255));
    var X,
      ac,
      ab = t(U, Y, aa),
      W = R(U, Y, aa),
    ...
    if (ab == W) {
      ...
      var Z = ab - W;
      switch (((ac = V > 0.5 ? Z / (2 - ab - W) : Z / (ab + W)), ab)) {
        case U:
          X = (Y - aa) / Z + (aa > Y ? 6 : 0);
          break;
        case Y:
  ...
  function z(Z, ac, Y) {
    ...
    var U, aa, ab;
    if (((Z = O(Z, 360)), (ac = O(ac, 100)), (Y = O(Y, 100)), 0 === ac)) {
      U = aa = ab = Y;
    } else {
      var V = 0.5 > Y ? Y * (1 + ac) : Y + ac - Y * ac,
        W = 2 * Y - V;
      (U = X(W, V, Z + 1 / 3)), (aa = X(W, V, Z)), (ab = X(W, V, Z - 1 / 3));
    }
    return { r: 255 * U, g: 255 * aa, b: 255 * ab };
  }
  function h(U, X, Z) {
    (U = O(U, 255)), (X = O(X, 255)), (Z = O(Z, 255));
    var W,
      ac,
      aa = t(U, X, Z),
      V = R(U, X, Z),
    ...
    return { h: W, s: ac, v: ab };
  }
  function H(Y, af, ad) {
    (Y = 6 * O(Y, 360)), (af = O(af, 100)), (ad = O(ad, 100));
    var X = w.floor(Y),
      aa = Y - X,
      W = ad * (1 - af),
      V = ad * (1 - aa * af),
      ...
      U = [ad, V, W, W, ae, ad][ac],
      Z = [ae, ad, ad, V, W, W][ac],
      ab = [W, W, ae, ad, ad, V][ac];
    return { r: 255 * U, g: 255 * Z, b: 255 * ab };
  }
  function I(X, W, U, Y) {
    var V = [y(A(X).toString(16)), y(A(W).toString(16)), y(A(U).toString(16))];
    return Y &&
      V[0].charAt(0) == V[0].charAt(1) &&
      V[1].charAt(0) == V[1].charAt(1) &&
      V[2].charAt(0) == V[2].charAt(1)
      ? V[0].charAt(0) + V[1].charAt(0) + V[2].charAt(0)
      : V.join("");
  }
  function S(Y, X, U, V) {
    var W = [
  ...
  function v(V, W) {
    W = 0 === W ? 0 : W || 10;
    var U = M(V).toHsl();
    return (U.s -= W / 100), (U.s = a(U.s)), M(U);
  }
  function G(V, W) {
    W = 0 === W ? 0 : W || 10;
    var U = M(V).toHsl();
  ...
  function e(U) {
    return M(U).desaturate(100);
  }
  function r(V, W) {
    W = 0 === W ? 0 : W || 10;
    var U = M(V).toHsl();
    return (U.l += W / 100), (U.l = a(U.l)), M(U);
  }
  function b(U, W) {
    W = 0 === W ? 0 : W || 10;
    var V = M(U).toRgb();
    return (
      (V.r = t(0, R(255, V.r - A(255 * -(W / 100))))),
      (V.g = t(0, R(255, V.g - A(255 * -(W / 100))))),
      (V.b = t(0, R(255, V.b - A(255 * -(W / 100))))),
      M(V)
    );
  }
  function p(V, W) {
  ...
  function L(W, X) {
    var V = M(W).toHsl(),
      U = (A(V.h) + X) % 360;
    return (V.h = 0 > U ? 360 + U : U), M(V);
  }
  function D(V) {
    var U = M(V).toHsl();
    return (U.h = (U.h + 180) % 360), M(U);
  }
  function f(V) {
    var U = M(V).toHsl(),
      W = U.h;
    return [
      M(V),
      M({ h: (W + 120) % 360, s: U.s, l: U.l }),
      M({ h: (W + 240) % 360, s: U.s, l: U.l }),
    ];
  }
  function Q(V) {
    var U = M(V).toHsl(),
    ...
    return [
      M(V),
      M({ h: (W + 90) % 360, s: U.s, l: U.l }),
      M({ h: (W + 180) % 360, s: U.s, l: U.l }),
      M({ h: (W + 270) % 360, s: U.s, l: U.l }),
    ];
  }
  function B(V) {
    var U = M(V).toHsl(),
    ...
    return [
      M(V),
      M({ h: (W + 72) % 360, s: U.s, l: U.l }),
      M({ h: (W + 216) % 360, s: U.s, l: U.l }),
    ];
  }
  function x(V, Y, Z) {
    (Y = Y || 6), (Z = Z || 30);
    var U = M(V).toHsl(),
      X = 360 / Z,
      W = [M(V)];
    for (U.h = (U.h - ((X * Y) >> 1) + 720) % 360; --Y; ) {
      (U.h = (U.h + X) % 360), W.push(M(U));
    }
    return W;
  }
  function s(W, Z) {
    Z = Z || 6;
    for (
      var Y = M(W).toHsv(), ab = Y.h, aa = Y.s, V = Y.v, X = [], U = 1 / Z;
      Z--;

    ) {
      X.push(M({ h: ab, s: aa, v: V })), (V = (V + U) % 1);
    }
    return X;
  }
  function P(W) {
    var V = {};
    for (var U in W) {
      W.hasOwnProperty(U) && (V[W[U]] = U);
    }
    return V;
  }
  function k(U) {
    return (U = parseFloat(U)), (isNaN(U) || 0 > U || U > 1) && (U = 1), U;
  }
  function O(W, U) {
    E(W) && (W = "100%");
    var V = m(W);
    return (
      (W = R(U, t(0, parseFloat(W)))),
      V && (W = parseInt(W * U, 10) / 100),
      w.abs(W - U) < 0.000001 ? 1 : (W % U) / parseFloat(U)
    );
  }
  function a(U) {
    return R(1, t(0, U));
  ...
  function E(U) {
    return "string" == typeof U && -1 != U.indexOf(".") && 1 === parseFloat(U);
  }
  function m(U) {
    return "string" == typeof U && -1 != U.indexOf("%");
  }
  function y(U) {
    return 1 == U.length ? "0" + U : "" + U;
  }
  function o(U) {
    return 1 >= U && (U = 100 * U + "%"), U;
  }
  function C(U) {
    return Math.round(255 * parseFloat(U)).toString(16);
  }
  function i(U) {
    return c(U) / 255;
  }
  function u(V) {
    V = V.replace(F, "").replace(q, "").toLowerCase();
    var U = !1;
    if (N[V]) {
      (V = N[V]), (U = !0);
    } else {
    ...
    var W;
    return (W = d.rgb.exec(V))
      ? { r: W[1], g: W[2], b: W[3] }
      : (W = d.rgba.exec(V))
      ? { r: W[1], g: W[2], b: W[3], a: W[4] }
      : (W = d.hsl.exec(V))
      ? { h: W[1], s: W[2], l: W[3] }
      : (W = d.hsla.exec(V))
      ? { h: W[1], s: W[2], l: W[3], a: W[4] }
      : (W = d.hsv.exec(V))
      ? { h: W[1], s: W[2], v: W[3] }
      : (W = d.hsva.exec(V))
      ? { h: W[1], s: W[2], v: W[3], a: W[4] }
      : (W = d.hex8.exec(V))
      ? {
          a: i(W[1]),
          r: c(W[2]),
      ...
      : (W = d.hex6.exec(V))
      ? { r: c(W[1]), g: c(W[2]), b: c(W[3]), format: U ? "name" : "hex" }
      : (W = d.hex3.exec(V))
      ? {
          r: c(W[1] + "" + W[1]),
          g: c(W[2] + "" + W[2]),
  ...
  function l(V) {
    var W, U;
    return (
      (V = V || { level: "AA", size: "small" }),
      (W = (V.level || "AA").toUpperCase()),
      (U = (V.size || "small").toLowerCase()),
      "AA" !== W && "AAA" !== W && (W = "AA"),
  ...
  (M.prototype = {
    ...
    getBrightness: function () {
      var U = this.toRgb();
      return (299 * U.r + 587 * U.g + 114 * U.b) / 1000;
    },
    getLuminance: function () {
      ...
      return (
        ...
        (V = U.g / 255),
        (Z = U.b / 255),
        (Y = 0.03928 >= W ? W / 12.92 : Math.pow((W + 0.055) / 1.055, 2.4)),
        (X = 0.03928 >= V ? V / 12.92 : Math.pow((V + 0.055) / 1.055, 2.4)),
        (aa = 0.03928 >= Z ? Z / 12.92 : Math.pow((Z + 0.055) / 1.055, 2.4)),
        0.2126 * Y + 0.7152 * X + 0.0722 * aa
      );
    },
    setAlpha: function (U) {
      return (this._a = k(U)), (this._roundA = A(100 * this._a) / 100), this;
    },
    toHsv: function () {
      var U = h(this._r, this._g, this._b);
      return { h: 360 * U.h, s: U.s, v: U.v, a: this._a };
    },
    toHsvString: function () {
      var V = h(this._r, this._g, this._b),
        X = A(360 * V.h),
        W = A(100 * V.s),
        U = A(100 * V.v);
      return 1 == this._a
        ? "hsv(" + X + ", " + W + "%, " + U + "%)"
        : "hsva(" + X + ", " + W + "%, " + U + "%, " + this._roundA + ")";
    },
    toHsl: function () {
      var U = n(this._r, this._g, this._b);
      return { h: 360 * U.h, s: U.s, l: U.l, a: this._a };
    },
    toHslString: function () {
      var V = n(this._r, this._g, this._b),
        X = A(360 * V.h),
        W = A(100 * V.s),
        U = A(100 * V.l);
      return 1 == this._a
        ? "hsl(" + X + ", " + W + "%, " + U + "%)"
        : "hsla(" + X + ", " + W + "%, " + U + "%, " + this._roundA + ")";
    },
    toHex: function (U) {
      return I(this._r, this._g, this._b, U);
    },
    ...
    toPercentageRgb: function () {
      return {
        r: A(100 * O(this._r, 255)) + "%",
        g: A(100 * O(this._g, 255)) + "%",
        b: A(100 * O(this._b, 255)) + "%",
        a: this._a,
      };
    },
    ...
    toName: function () {
      return 0 === this._a
        ...
        : this._a < 1
        ? !1
        : T[I(this._r, this._g, this._b, !0)] || !1;
    },
    toFilter: function (X) {
      var Y = "#" + S(this._r, this._g, this._b, this._a),
        V = Y,
        U = this._gradientType ? "GradientType = 1, " : "";
      if (X) {
        var W = M(X);
        V = W.toHex8String();
      }
    ...
    toString: function (X) {
      ...
      var W = !1,
        ...
        Y =
          !U &&
          V &&
          ("hex" === X || "hex6" === X || "hex3" === X || "name" === X);
      return Y
        ? "name" === X && 0 === this._a
          ? this.toName()
          : this.toRgbString()
        : ("rgb" === X && (W = this.toRgbString()),
          "prgb" === X && (W = this.toPercentageRgbString()),
          ("hex" === X || "hex6" === X) && (W = this.toHexString()),
          "hex3" === X && (W = this.toHexString(!0)),
          "hex8" === X && (W = this.toHex8String()),
          "name" === X && (W = this.toName()),
          "hsl" === X && (W = this.toHslString()),
          "hsv" === X && (W = this.toHsvString()),
          W || this.toHexString());
    },
    _applyModification: function (W, V) {
      var U = W.apply(null, [this].concat([].slice.call(V)));
      return (
        (this._r = U._r),
        (this._g = U._g),
        (this._b = U._b),
    ...
    _applyCombination: function (V, U) {
      return V.apply(null, [this].concat([].slice.call(U)));
    },
    analogous: function () {
    ...
    (M.fromRatio = function (U, X) {
      if ("object" == typeof U) {
        var V = {};
        for (var W in U) {
          U.hasOwnProperty(W) && (V[W] = "a" === W ? U[W] : o(U[W]));
        }
        U = V;
      }
      return M(U, X);
    }),
    (M.equals = function (V, U) {
      return V && U ? M(V).toRgbString() == M(U).toRgbString() : !1;
    }),
    (M.random = function () {
      return M.fromRatio({ r: j(), g: j(), b: j() });
    }),
    (M.mix = function (ae, ad, Z) {
      Z = 0 === Z ? 0 : Z || 50;
      var aa,
        Y = M(ae).toRgb(),
        W = M(ad).toRgb(),
    ...
    (M.readability = function (V, U) {
      var X = M(V),
        W = M(U);
      return (
        (Math.max(X.getLuminance(), W.getLuminance()) + 0.05) /
        (Math.min(X.getLuminance(), W.getLuminance()) + 0.05)
      );
    }),
    (M.isReadable = function (V, U, Z) {
      var X,
        W,
        Y = M.readability(V, U);
      switch (((W = !1), (X = l(Z)), X.level + X.size)) {
        case "AAsmall":
        case "AAAlarge":
          W = Y >= 4.5;
          break;
    ...
    (M.mostReadable = function (ab, aa, ac) {
      var W,
        X,
        U,
        ad,
        ...
        V = 0;
      (ac = ac || {}),
        (X = ac.includeFallbackColors),
        (U = ac.level),
        (ad = ac.size);
      for (var Z = 0; Z < aa.length; Z++) {
        (W = M.readability(ab, aa[Z])), W > V && ((V = W), (Y = M(aa[Z])));
      }
      return M.isReadable(ab, Y, { level: U, size: ad }) || !X
        ? Y
        : ((ac.includeFallbackColors = !1),
          M.mostReadable(ab, ["#fff", "#000"], ac));
    });
  var N = (M.names = {
      aliceblue: "f0f8ff",
      antiquewhite: "faebd7",
...
!(function (a) {
  ...
  function D(a5, at) {
    ...
    function L(bc) {
      ...
      return (
        ...
        bb() || !al()
          ...
          ? (at.preventDefaultEvents !== !1 && bc.preventDefault(),
            (Z = h),
            O(bd, Z))
    ...
    function ad() {
      return null !== at.pinchThreshold ? ao >= at.pinchThreshold : !0;
    }
    function az() {
      var bc;
      return (bc = at.maxTimeThreshold ? !(ab >= at.maxTimeThreshold) : !0);
    }
    function aj(bc, bd) {
    ...
    function a0() {
      return ab > at.longTapThreshold && r > af;
    }
    function ag() {
      return !(!av() || !a7());
    }
    ...
    function aS(bc) {
      return M[bc] ? M[bc].distance : void 0;
    }
    function aa() {
      var bc = {};
      return (
 ...
 */
!(function (b) {
  (b.isBreakpoint = function (a) {
    var f, e;
    return (
      (f = b("<div/>", { class: "visible-" + a }).appendTo("body")),
      (e = f.is(":visible")),
      f.remove(),
      e
    );
    ...
    b.extend(b, {
      isXs: function () {
        return b.isBreakpoint("xs");
      },
      isSm: function () {
        return b.isBreakpoint("sm");
      },
      isMd: function () {
        return b.isBreakpoint("md");
      },
      isLg: function () {
        return b.isBreakpoint("lg");
      },
    });
})(jQuery);
/*!
...
!(function (a) {
  (a.gritter = {}),
    ...
    (a.gritter.add = function (d) {
      try {
        return b.add(d || {});
      } catch (c) {
        var e = "Gritter Error: " + c;
        "undefined" != typeof console && console.error
          ? console.error(e, d)
          : alert(e);
      }
    }),
    (a.gritter.remove = function (d, c) {
      b.removeSpecific(d, c || {});
    }),
    (a.gritter.removeAll = function (c) {
      b.stop(c || {});
    });
  var b = {
    position: "",
    ...
    _tpl_item:
      '<div id="gritter-item-[[number]]" class="gritter-item-wrapper [[item_class]]" style="display:none" role="alert"><div class="gritter-item">[[image]]<div class="gritter-content [[class_name]]">[[close]][[title]]<p>[[text]]</p></div><div style="clear:both"></div></div></div>',
    _tpl_wrap:
      '<div id="gritter-notice-wrapper" class="gritter-main-wrapper"></div>',
    add: function (q) {
      if (("string" == typeof q && (q = { text: q }), null === q.text)) {
      ...
      var e = this._item_count,
        k = this._tpl_item;
      a(["before_open", "after_open", "before_close", "after_close"]).each(
        function (c, f) {
          b["_" + f + "_" + e] = a.isFunction(q[f]) ? q[f] : function () {};
        }
      ),
        (this._custom_timer = 0),
        x && (this._custom_timer = x);
      var y =
          "" != h
            ? '<div class="gritter-img-container"><img src="' +
              h +
              '" class="gritter-image" /></div>'
            : "",
        t = "" != h ? "gritter-with-image" : "gritter-without-image";
      if (
        ((d = d ? this._str_replace("[[title]]", d, this._tpl_title) : ""),
        (k = this._str_replace(
          [
            "[[title]]",
            "[[text]]",
          ...
          [d, g, this._tpl_close, y, this._item_count, t, w],
          k
        )),
        this["_before_open_" + e]() === !1)
      ) {
        return !1;
      }
      a("#gritter-notice-wrapper").addClass(v).append(k);
      var j = a("#gritter-item-" + this._item_count);
      return (
        j.fadeIn(this.fade_in_speed, function () {
          b["_after_open_" + e](a(this));
        }),
        z || this._setFadeTimer(j, e),
        a(j).bind("mouseenter mouseleave", function (c) {
          "mouseenter" == c.type
            ? z || b._restoreItemIfFading(a(this), e)
            : z || b._setFadeTimer(a(this), e),
            b._hoverState(a(this), c.type);
        }),
        a(j)
          .find(".gritter-close")
          .click(function () {
            return b.removeSpecific(e, {}, null, !0), !1;
          }),
        e
      );
    },
    _countRemoveWrapper: function (f, c, d) {
      c.remove(),
        this["_after_close_" + f](c, d),
        0 == a(".gritter-item-wrapper").length &&
          a("#gritter-notice-wrapper").remove();
    },
    _fade: function (e, d, g, h) {
      var g = g || {},
        j = "undefined" != typeof g.fade ? g.fade : !0,
        f = g.speed || this.fade_out_speed,
        c = h;
      this["_before_close_" + d](e, c),
        h && e.unbind("mouseenter mouseleave"),
        j
          ? e.animate({ opacity: 0 }, f, function () {
              e.animate({ height: 0 }, 300, function () {
                b._countRemoveWrapper(d, e, c);
              });
            })
          : this._countRemoveWrapper(d, e);
    },
    _hoverState: function (c, d) {
      "mouseenter" == d
        ? (c.addClass("hover"), c.find(".gritter-close").show())
        : (c.removeClass("hover"), c.find(".gritter-close").hide());
    },
    removeSpecific: function (f, c, d, g) {
      if (!d) {
        var d = a("#gritter-item-" + f);
      }
      this._fade(d, f, c || {}, g);
    },
    _restoreItemIfFading: function (c, d) {
      clearTimeout(this["_int_id_" + d]),
        c.stop().css({ opacity: "", height: "" });
    },
    _runSetup: function () {
      for (opt in a.gritter.options) {
        this[opt] = a.gritter.options[opt];
      }
      this._is_setup = 1;
    },
    _setFadeTimer: function (d, c) {
      var e = this._custom_timer ? this._custom_timer : this.time;
      this["_int_id_" + c] = setTimeout(function () {
        b._fade(d, c);
      }, e);
    },
    stop: function (f) {
      var c = a.isFunction(f.before_close) ? f.before_close : function () {},
    ...
    _str_replace: function (C, x, v, d) {
      ...
      for (
        B = [].concat(B), d && (this.window[d] = 0), h = 0, y = B.length;
        y > h;
        h++
      ) {
        if ("" !== B[h]) {
          for (j = 0, A = g.length; A > j; j++) {
            (D = B[h] + ""),
              (z = w ? (void 0 !== q[j] ? q[j] : "") : q[0]),
              (B[h] = D.split(g[j]).join(z)),
              d &&
                B[h] !== D &&
                (this.window[d] += (D.length - B[h].length) / g[j].length);
          }
        }
      }
      return k ? B : B[0];
    ...
    _verifyWrapper: function () {
      0 == a("#gritter-notice-wrapper").length &&
        a("body").append(this._tpl_wrap);
    },
  };
})(jQuery);
...
(function (a) {
  if (typeof define === "function" && define.amd) {
    return define(["jquery"], function (b) {
      return a(b, window, document);
    });
  } else {
    if (typeof exports === "object") {
      return (module.exports = a(require("jquery"), window, document));
    } else {
      return a(jQuery, window, document);
    }
  }
})(function (g, o, B) {
  var c,
  ...
  k = "touchmove";
  c =
    o.navigator.appName === "Microsoft Internet Explorer" &&
  ...
  h = (function () {
    var K, J, N, M, L, I;
    M = ["t", "webkitT", "MozT", "msT", "OT"];
    for (K = L = 0, I = M.length; L < I; K = ++L) {
      N = M[K];
      J = M[K] + "ransform";
      if (J in n) {
        return M[K].substr(0, M[K].length - 1);
      }
    }
    return false;
  })();
  y = function (I) {
    ...
    return h + I.charAt(0).toUpperCase() + I.substr(1);
  };
  w = y("transform");
  i = w !== false;
  x = function () {
  ...
  l = function () {
    ...
    K = /(?=.+Mac OS X)(?=.+Firefox)/.test(J);
    if (!K) {
      return false;
    }
    I = /Firefox\/\d{2}\./.exec(J);
    if (I) {
      I = I[0].replace(/\D+/g, "");
    }
    return K && +I > 23;
  ...
  H = (function () {
    ...
    I.prototype.preventScrolling = function (K, J) {
      if (!this.isActive) {
        return;
      }
      if (K.type === j) {
        if (
          (J === F && K.originalEvent.detail > 0) ||
          (J === f && K.originalEvent.detail < 0)
        ) {
          K.preventDefault();
        }
        ...
        if (K.type === G) {
          if (!K.originalEvent || !K.originalEvent.wheelDelta) {
            return;
          }
          if (
            (J === F && K.originalEvent.wheelDelta < 0) ||
            (J === f && K.originalEvent.wheelDelta > 0)
          ) {
            K.preventDefault();
          }
    ...
    I.prototype.setOnScrollStyles = function () {
      ...
      if (i) {
        J = {};
        J[w] = "translate(0, " + this.sliderTop + "px)";
      } else {
        J = { top: this.sliderTop };
      }
      if (C) {
        if (p && this.scrollRAF) {
          p(this.scrollRAF);
    ...
    I.prototype.createEvents = function () {
      this.events = {
        down: (function (J) {
          return function (K) {
            J.isBeingDragged = true;
            J.offsetY = K.pageY - J.slider.offset().top;
            if (!J.slider.is(K.target)) {
              J.offsetY = 0;
            }
            J.pane.addClass("active");
            J.doc.bind(A, J.events[d]).bind(m, J.events[f]);
            J.body.bind(E, J.events[s]);
            return false;
          };
        })(this),
        drag: (function (J) {
          return function (K) {
            J.sliderY =
              ...
              J.$el.offset().top -
              J.paneTop -
              (J.offsetY || J.sliderHeight * 0.5);
            J.scroll();
            if (
              J.contentScrollTop >= J.maxScrollTop &&
              J.prevScrollTop !== J.maxScrollTop
            ) {
              J.$el.trigger("scrollend");
            } else {
              if (J.contentScrollTop === 0 && J.prevScrollTop !== 0) {
                J.$el.trigger("scrolltop");
              }
            }
            return false;
          };
        ...
        panedown: (function (J) {
          return function (K) {
            J.sliderY =
              (K.offsetY || K.originalEvent.layerY) - J.sliderHeight * 0.5;
            J.scroll();
            J.events.down(K);
            return false;
          };
        ...
        scroll: (function (J) {
          return function (K) {
            J.updateScrollValues();
            if (J.isBeingDragged) {
              return;
            }
            if (!J.iOSNativeScrolling) {
              J.sliderY = J.sliderTop;
              J.setOnScrollStyles();
            }
            if (K == null) {
              return;
            }
            if (J.contentScrollTop >= J.maxScrollTop) {
              if (J.options.preventPageScrolling) {
                J.preventScrolling(K, F);
              }
              if (J.prevScrollTop !== J.maxScrollTop) {
                J.$el.trigger("scrollend");
              }
            } else {
              if (J.contentScrollTop === 0) {
                if (J.options.preventPageScrolling) {
                  J.preventScrolling(K, f);
                }
                if (J.prevScrollTop !== 0) {
                  J.$el.trigger("scrolltop");
                }
              }
            }
        ...
        wheel: (function (J) {
          return function (K) {
            ...
            L =
              K.delta ||
              K.wheelDelta ||
              (K.originalEvent && K.originalEvent.wheelDelta) ||
              -K.detail ||
              (K.originalEvent && -K.originalEvent.detail);
            if (L) {
              J.sliderY += -L / 3;
            }
            J.scroll();
        ...
        enter: (function (J) {
          return function (L) {
            ...
            if ((L.buttons || L.which) !== 1) {
              return (K = J.events)[f].apply(K, arguments);
            }
          };
        })(this),
      };
    ...
    I.prototype.generate = function () {
      var L, M, N, K, P, J, O;
      K = this.options;
      (J = K.paneClass), (O = K.sliderClass), (L = K.contentClass);
      if (
        !(P = this.$el.children("." + J)).length &&
        !P.children("." + O).length
      ) {
        this.$el.append(
          '<div class="' + J + '"><div class="' + O + '" /></div>'
        );
      }
    ...
    I.prototype.reset = function () {
      ...
      R = P.scrollHeight + r;
      Q = parseInt(this.$el.css("max-height"), 10);
      if (Q > 0) {
        this.$el.height("");
      ...
      N = J + M + L;
      O = Math.round((N / R) * J);
      if (O < this.options.sliderMinHeight) {
        O = this.options.sliderMinHeight;
      } else {
        if (
          this.options.sliderMaxHeight != null &&
          O > this.options.sliderMaxHeight
        ) {
          O = this.options.sliderMaxHeight;
        }
      }
      if (K === z && U.overflowX !== z) {
        O += r;
      }
      ...
      if (
        ...
        (this.pane.outerHeight(true) >= P.scrollHeight && K !== z)
      ) {
        this.pane.hide();
        this.isActive = false;
      } else {
        if (this.el.clientHeight === P.scrollHeight && K === z) {
          this.slider.hide();
        } else {
          this.slider.show();
        }
      ...
      if (T === "static" || T === "relative") {
        S = parseInt(this.$content.css("right"), 10);
        if (S) {
          this.$content.css({ right: "", marginRight: S });
        }
      }
      return this;
    };
    ...
    I.prototype.scrollBottom = function (J) {
      if (!this.isActive) {
        return;
      }
      this.$content
        .scrollTop(this.contentHeight - this.$content.height() - J)
        .trigger(G);
      this.stop().restore();
      return this;
    };
    I.prototype.scrollTop = function (J) {
      if (!this.isActive) {
        return;
      }
    ...
    I.prototype.scrollTo = function (J) {
      if (!this.isActive) {
        return;
      }
      this.scrollTop(this.$el.find(J).get(0).offsetTop);
      return this;
    };
  ...
  g.fn.nanoScroller = function (I) {
    return this.each(function () {
      var J, K;
      if (!(K = this.nanoscroller)) {
        J = g.extend({}, u, I);
        this.nanoscroller = K = new H(this, J);
      }
      if (I && typeof I === "object") {
        g.extend(K.options, I);
        if (I.scrollBottom != null) {
          return K.scrollBottom(I.scrollBottom);
        }
        if (I.scrollTop != null) {
          return K.scrollTop(I.scrollTop);
        }
        if (I.scrollTo) {
          return K.scrollTo(I.scrollTo);
        }
        if (I.scroll === "bottom") {
          return K.scrollBottom(0);
        }
        if (I.scroll === "top") {
          return K.scrollTop(0);
        }
        if (I.scroll && I.scroll instanceof g) {
          return K.scrollTo(I.scroll);
        }
        if (I.stop) {
          return K.stop();
        }
...
var share = (function () {
  var m = {
    ...
    whatsapp: [
      "",
      "api.whatsapp.com/send/?phone&app_absent=0&",
      "",
      620,
      620,
      "text",
    ],
    googleplus: ["s", "plus.google.com/share?", "", 620, 620, "url"],
    twitter: [
      "",
    ...
    reddit: ["", "reddit.com/submit?", "", 650, 1024, "url", "title"],
    digg: ["", "digg.com/submit?", "", 650, 1024, "url"],
    ameba: [
      "",
      "blog.ameba.jp/ucs/entry/srventryinsertinput.do?editor_flg=1&",
      "",
      650,
      1024,
      "",
    ...
    skyblog: [
      "",
      "skyrock.com/m/blog/share.php?idp=10&",
      "",
      730,
      1024,
      "url",
    ...
    tuenti: ["", "www.tuenti.com/share?", "", 650, 1024, "url"],
    meneame: ["", "meneame.net/submit.php?", "", 650, 1024, "url"],
    rakuten: [
      "",
      "my.plaza.rakuten.co.jp/index.phtml?func=diary&act=write&",
      "",
      800,
      1200,
      "",
    ...
    mixi: ["", "mixi.jp/share.pl?", "", 650, 1024, "u"],
    yahoo: [
      "",
      "blogs.yahoo.co.jp/FRONT/blogthis.html?",
      "",
      650,
      1024,
      "link",
    ...
    cyworld: ["", "api.cyworld.com/openscrap/video/v1/?", "", 410, 450, "vu"],
    kakao: ["s", "story.kakao.com/share?", "", 530, 480, "url"],
    naver: ["", "blog.naver.com/LinkShare.nhn?", "", 500, 560, "url"],
    weibo: [
      "",
    ...
    nujij: ["", "nujij.nl/jij.lynkx?", "", 650, 1024, "u", "t"],
    wykop: ["", "www.wykop.pl/dodaj?", "", 650, 1024, "url", "title", "desc"],
    fotka: ["", "www.fotka.pl/out/opis_importer.php?", "", 650, 1024, "url"],
    skype: ["s", "web.skype.com/share?", "", 650, 1024, "url"],
  };
  function b(s) {
    var y = encodeURIComponent($('meta[property="og:url"]').attr("content"));
    var u = encodeURIComponent($('meta[property="og:title"]').attr("content"));
    var C = encodeURIComponent($('meta[property="og:image"]').attr("content"));
    var e = $('meta[property="og:description:alternate"]').attr("content");
    if (typeof e === "undefined") {
      e = $('meta[property="og:description"]').attr("content");
    }
    e = encodeURIComponent(e);
    var A = m[s];
    var t = "http" + A[0] + "://" + (isMobile && A[2] != "" ? A[2] : A[1]);
    var v = "";
    switch (s) {
      case "twitter":
      ...
      case "rakuten":
        ...
        var x = i.indexOf("Trident/") == -1 && i.indexOf("Edge/") == -1;
        e +=
          "<br><br>" +
          (x ? '<a href="' + y + '">' : "") +
          '<img alt="' +
        ...
        if (s == "livejournal") {
          e =
            '<xml:namespace ns="livejournal" prefix="lj">' +
            e +
            "</xml:namespace>";
        }
        break;
    ...
    var z = Math.min(A[3], parseInt($(window).height(), 10));
    var B = Math.min(A[4], parseInt($(window).width(), 10));
    window.open(
      t,
      "",
      "toolbar=0,status=0,location=1,scrollbars=1,height=" +
        z +
        ",width=" +
        B +
        ""
  ...
  function j(w) {
    ...
    if (w) {
      ...
      e.push("theme=" + (configC.themeNightMode ? 1 : 0));
      if (configC.themeColorId !== getDefaultColorId()) {
        e.push("color=" + configC.themeColorId);
      }
      if (
        $("#chk-show-buttons").length &&
        !$("#chk-show-buttons").prop("checked")
      ) {
        var u = e.indexOf("enabled=0");
        if (u > -1) {
          e[u] = "enabled=1";
        } else {
          if (typeof vStopwatch !== "undefined") {
        ...
        e.push("showbuttons=0");
      }
      if (typeof vStopwatch === "undefined") {
        e.push("ampm=" + (configC.clock12hour ? 1 : 0));
        if (typeof vAlarm !== "undefined" || typeof vClock !== "undefined") {
          e.push("showdate=" + (configC.clockDateVisible ? 1 : 0));
        }
        if (typeof vAlarm !== "undefined") {
          e.push("sound=" + configC.alarmAudioCode);
        }
        if (typeof vTimer !== "undefined") {
          e.push("sound=" + configC.timerAudioCode);
        }
      } else {
        if (configC.swTimeFormat !== 1) {
          e.push("format=" + configC.swTimeFormat);
        }
      }
    }
    if (e.length === 0) {
  ...
  var d;
  var f = $('meta[property="og:url"]').attr("content");
  ...
  var p = $('link[type="embed"]').attr("href");
  try {
    if (p.indexOf("?") === -1) {
      p = decodeURI(p);
    }
  ...
  $("#edt-embed").bind("input propertychange", function () {
    clearTimeout(d);
    d = setTimeout(n, 1000);
  });
  function n() {
    $(".embed-preview").html($("#edt-embed").val());
    clearTimeout(d);
  }
  $("#btn-tool-share").click(function () {
    var e = $("#pnl-share").find(".panel");
    hideTooltips();
    $("html, body").animate({ scrollTop: $(document).height() }, 400);
    fadeHighlight(e, 1000);
  });
  var r = [
    [125, 40],
    [125, 125],
  ...
  if (o.length > 0) {
    ...
    for (var k = 0; k < r.length; k++) {
      q += "<option>" + r[k][0] + " × " + r[k][1] + "</option>";
    }
    o.html(q + o.html());
    o[0].selectedIndex = r.length - 7;
    o.change(a);
  }
  $("#chk-show-buttons").prop("checked", configC.buttonsVisible).change(a);
  return { popup: b };
})();
